...
struct CRF_State
{
  public:
    ...
    void add_feature(const std::string & f)
    {
        ...
        {
            std::cerr << "error: illegal characters in a feature string" << std::endl; exit(1); 
        }
...
/**
 * This is the main class used in Lapos - it is around 390 lines long of declarations and members.
 * I don't wanna bother cleaning it up or optimising it, I think I'll just use laPOS the dirtiest and simplest way.
 */
class CRF_Model
{
 public:
